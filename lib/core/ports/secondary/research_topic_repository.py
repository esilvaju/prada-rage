...
class ResearchTopicRepository(ABC):
    ...
    @abstractmethod
    def register_source_doc(self, research_goal: ResearchTopic, source_doc: Document) -> RegisterSourceDocDTO:
        """
        Register a source document for a research goal.

        @param research_goal: The research goal to register the source document for.
        @type research_goal: ResearchGoal
    ...
    def unregister_source_doc(self, research_goal: ResearchTopic, source_doc: Document):
        ...
        @param research_goal: The research goal to unregister the source document for.
        @type research_goal: ResearchGoal
    ...
    def archive_research_goal(self, research_goal: ResearchTopic):
        ...
        @param research_goal: The research goal to archive.
        @type research_goal: ResearchGoal
        """
        pass