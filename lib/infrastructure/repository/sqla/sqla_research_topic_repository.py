...
from lib.infrastructure.repository.sqla.models import SQLADocument, SQLAResearchTopic
...
class SQLAResearchTopicRepository(ResearchTopicRepository):
    ...
    def register_source_doc(self, research_topic, source_doc):
        ...
        research_topic: SQLAResearchTopic | None = self.session.get(SQLAResearchTopic, research_topic.id)
        if research_topic is None:
